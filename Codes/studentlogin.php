  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <form action=" " method="POST">
        ...
        <div class="content">
          <div class="pass-link"><a href="student_reset.php">Forgot password?</a></div>
        </div>
        <div class="field">
...
{ 
  ...
  $sql = "select * from student where email = '$username' and pswd = '$password'";
  $result = mysqli_query($con, $sql);
  $row = mysqli_fetch_array($result, MYSQLI_ASSOC);  
  $count = mysqli_num_rows($result);
          
  if($count == 1){
    $_SESSION["usrname"] = $row['first_name'];
    $_SESSION["id"] = $row['id'];
